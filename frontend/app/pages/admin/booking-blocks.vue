      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-header bg-white fw-bold py-3">
            <i class="bi bi-slash-circle me-2 text-danger"></i>Zablokovať termín
          </div>
          <div class="card-body">
            <form @submit.prevent="addBlock">
              ...
              <div class="mb-3">
                ...
                <select v-model="form.service_id" class="form-select form-select-sm">
                  <option :value="null">— Všetky karavany —</option>
                  <option v-for="s in services" :key="s.id" :value="s.id">{{ s.title }}</option>
                </select>
                <div class="form-text">Prázdne = blok platí pre všetky karavany</div>
              </div>

              <div class="mb-3">
                <label class="form-label small fw-semibold">Dátum od *</label>
                <input
              ...
              <div class="mb-3">
                <label class="form-label small fw-semibold">Dátum do <span class="text-muted fw-normal">(nepovinné, pre jednodňový blok nechajte prázdne)</span></label>
                <input
              ...
              <div class="mb-3">
                <label class="form-label small fw-semibold">Dôvod <span class="text-muted fw-normal">(nepovinné)</span></label>
                <input v-model="form.reason" type="text" class="form-control form-control-sm" placeholder="Napr. Údržba, Rezervované..." />
              </div>
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-header bg-white py-3 d-flex align-items-center gap-3">
            <span class="fw-bold">Blokované termíny</span>
            ...
            <table class="table table-hover mb-0 align-middle">
              ...
              <tbody>
                <tr v-for="block in blocks" :key="block.id">
                  ...
                  <td class="small text-muted">{{ block.service?.title || '— Všetky —' }}</td>
...
const formatDate = (d: string) =>
  new Date(d).toLocaleDateString('sk-SK', { day: 'numeric', month: 'numeric', year: 'numeric' })
