<template>
  <footer class="site-footer mt-auto">
    <div class="container">
      <div class="row g-4 g-lg-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p class="footer-desc">
            Prenájom karavanov pre nezabudnuteľné prázdniny. Moderné a dobre vybavené karavany pre vaše výlety.
          </p>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="footer-contact-item">
            ...
            <a :href="`mailto:${settings.email || 'info@campingforyou.sk'}`">
              {{ settings.email || 'info@campingforyou.sk' }}
            </a>
          </div>
          <div class="footer-contact-item">
            <i class="bi bi-geo-alt-fill"></i>
            <a :href="`https://maps.google.com/?q=${encodeURIComponent(settings.address || 'Hlavná 123, Bratislava')}`" target="_blank" rel="noopener">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <nav class="footer-nav">
            ...
            <NuxtLink :to="localePath({ name: 'pricing' })">Cenník</NuxtLink>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="text-center">
          &copy; {{ new Date().getFullYear() }} CampingForYou. Všetky práva vyhradené.
        </p>
      </div>
    </div>
  </footer>
